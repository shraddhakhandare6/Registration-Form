package RegistrationForm_using_JDBC;
import javax.swing.*;
import java.awt.*;
...
public class RegistrationForm implements ActionListener {
	...
	public void setLocationAndSize() {nameLabel.setBounds(20,20,40,70);
		genderLabel.setBounds(20, 70, 80, 70);
		fatherLabel.setBounds(20,120,100,70);
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==registerButton) {
					try {
						...
						pstmt.setString(3, fatherTextField.getText());
						pstmt.setString(4, passwordField.getText());
						pstmt.setString(5, confirmPasswordField.getText());
						pstmt.setString(6, cityTextField.getText());
